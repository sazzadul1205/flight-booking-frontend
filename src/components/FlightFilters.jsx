...
const FlightFilters = ({
  ...
  return (
    // FIX: Added sticky positioning with proper height and overflow
    <div className="sticky top-4 h-fit max-h-[calc(100vh-2rem)] overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-xl border border-blue-100/50">
        {/* Header */}
            ...
            <>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      type="number"
                      placeholder={
                        filterOptions?.min_price?.toString() || "Min"
                      }
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      placeholder={
                        filterOptions?.max_price?.toString() || "Max"
                      }
                ...
                renderSection(
                  ...
                  <div className="flex flex-wrap gap-1.5 max-h-32 overflow-y-auto">
                    {filterOptions.onward_destination_airport.map((airport) => (
                      ...
                      >
                        {filters.onward_destination_airport.includes(
                          airport,
                        ) && <FaCheck className="inline mr-1.5 w-2.5 h-2.5" />}
              ...
              {journeyType === 2 && (
                <>
                    ...
                    renderSection(
                      ...
                      <div className="flex flex-wrap gap-1.5 max-h-32 overflow-y-auto">
                        {filterOptions.return_layover_airport.map((airport) => (
                          ...
                          >
                            {filters.return_layover_airport.includes(
                              airport,
                            ) && (
                              <FaCheck className="inline mr-1.5 w-2.5 h-2.5" />
                            )}
                  ...
                  {(filterOptions?.return_destination_airport || []).length >
                    0 &&
                    renderSection(
                      "Return Destination Airports",
                      "returnDestination",
